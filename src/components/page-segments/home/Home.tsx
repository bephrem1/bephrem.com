            ...
            <div className="mt-2 flex flex-col gap-1">
              ...
              >
                <span className="grid w-full grid-cols-[4.75rem_1fr_auto] items-baseline gap-x-6 text-[0.8125rem] leading-snug text-neutral-800 hover:text-neutral-950 sm:text-[0.875rem]">
                  ...
                  <span className="min-w-0 truncate whitespace-nowrap">SVFF Cycle 1: Room Tone</span>
                  <span className="shrink-0 text-neutral-500">↗</span>
                </span>
              </a>
              <a
                href="https://writing.bephrem.com/p/production-design-series-b-office"
                target="_blank"
                rel="noopener noreferrer"
                className="block w-full text-inherit"
              >
                <span className="grid w-full grid-cols-[4.75rem_1fr_auto] items-baseline gap-x-6 text-[0.8125rem] leading-snug text-neutral-800 hover:text-neutral-950 sm:text-[0.875rem]">
                  ...
                  <span className="min-w-0 truncate whitespace-nowrap">Production Design: Series B Office</span>
                  <span className="shrink-0 text-neutral-500">↗</span>
                </span>
              </a>
              <a
                href="https://x.com/bephrem/status/2066618376466931940"
                target="_blank"
                rel="noopener noreferrer"
                className="block w-full text-inherit"
              >
                <span className="grid w-full grid-cols-[4.75rem_1fr_auto] items-baseline gap-x-6 text-[0.8125rem] leading-snug text-neutral-800 hover:text-neutral-950 sm:text-[0.875rem]">
                  ...
                  <span className="min-w-0 truncate whitespace-nowrap">14 Things I Look for in a Script</span>
                  <span className="shrink-0 text-neutral-500">↗</span>
                </span>
              </a>
              <a
                href="https://x.com/bephrem/status/2059343773965172956?s=20"
                target="_blank"
                rel="noopener noreferrer"
                className="block w-full text-inherit"
              >
                <span className="grid w-full grid-cols-[4.75rem_1fr_auto] items-baseline gap-x-6 text-[0.8125rem] leading-snug text-neutral-800 hover:text-neutral-950 sm:text-[0.875rem]">
                  ...
                  <span className="min-w-0 truncate whitespace-nowrap">The Tech Filmmaking Scene (May 2026)</span>
                  <span className="shrink-0 text-neutral-500">↗</span>
                </span>
              </a>
              <a
          ...
          <section>
            ...
            <div className="mt-2 flex flex-col gap-1">
              <div className="flex w-full items-baseline gap-x-3 text-[0.8125rem] leading-snug text-neutral-800 sm:text-[0.875rem]">
                <span className="w-[4.75rem] shrink-0 text-left tabular-nums text-neutral-600">8.20.26</span>
                <span className="min-w-0 flex-1 truncate whitespace-nowrap">#5: Producing</span>
                <span className="relative left-[9px] ml-auto grid w-[5.1rem] shrink-0 grid-cols-[1.3rem_1.3rem_1.9rem] justify-items-start text-neutral-500">
                  <a
                    href="https://x.com/bephrem/status/2094945747548672257?s=20"
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  <a
                    href="https://www.youtube.com/watch?v=R3MKJrUvMPY"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-left hover:text-neutral-700"
                  >
                  ...
                  <a
                    href="https://x.com/bephrem/status/2092286245158457558?s=20"
                    target="_blank"
                    rel="noopener noreferrer"
